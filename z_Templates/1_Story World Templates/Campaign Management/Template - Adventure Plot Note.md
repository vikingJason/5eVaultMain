...
RWtopicId: Topic_40
WorldAnvilLink: https://www.worldanvil.com/learn/article-templates/plot
---
# Template - Adventure Plot Note
## Overview
**Genre**: Alternative History
...
### Main Adversary Type
Nemesis, Villain, Henchmen

Depending on whether this is a Master Plot adventure, a side adventure, or some other kind of adventure you may need the Nemesis, a villain, just some henchmen.
...
### Parent Plot
**Please make sure** that the plot that you are about to set as its parent is not a child of this plot or any other of its children, or ... **doom**! (your plot list will stop working)
...
### Completion Date
The date this plot was completed (For TTRPG Campaigns)
...
## Relations
This section is about expanding the relationships between the characters (or PCs and NPCs) within the plot. It is, of course recommended that you use the @ mention system extensively.

### Protagonists
The stars of the show: these are the main characters of your story, or the PCs of your RPG campaign.

### Allies
The friendly supporting cast. Those who help by providing support of any type to the protagonists and share the same goals and ideals. They may be individual characters (or NPCs in an RPG game) or allied organisations.
