...
| Item | Cost |
|------|------|
| [Dancing monkey fruit](dancing-monkey-fruit-toa.md) | 5 gp |
| [Menga leaves (1 ounce)](menga-leaves-1-ounce-toa.md) | 2 gp |
| [Ryath root](ryath-root-toa.md) | 50 gp |
| [Sinda berries (10)](sinda-berries-10-toa.md) | 5 gp |
| [Wildroot](wildroot-toa.md) | 25 gp |
| [Wukka nut](wukka-nut-toa.md) | 1 gp |
| [Yahcha](yahcha-toa.md) | 1 gp |
| [Zabou](zabou-toa.md) | 10 gp |
^flora-and-fauna

### Dancing Monkey Fruit

This rare magical fruit produces enough juice to fill a vial. Any humanoid that eats a [dancing monkey fruit](dancing-monkey-fruit-toa.md) or drinks its juice must succeed on a DC 14 Constitution saving throw or begin a comic dance that lasts for 1 minute. Humanoids that can't be poisoned are immune to this magical effect.
...
A yahcha (pronounced YAH-chah) is a harmless, meaty beetle about the size of a human hand, which feeds on worms and maggots. It moves slowly (walking speed 10 feet) and is easy to catch. A creature with [blue mist fever](CLI/diseases.md#Blue%20Mist%20Fever) that eats a raw or cooked yahcha can immediately make a saving throw with advantage against that disease (see "Diseases," page 40).
