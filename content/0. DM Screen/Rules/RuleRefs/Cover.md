...
| --- | --- |
| **Cover** | +2 circumstance bonus to AC, Reflex saves against area effects, and Stealth checks to [[content/0. DM Screen/Rules/PF2E/actions/hide]] or [[sneak]]. You can use [[Take Cover]] to increase this to greater cover. |
| **Greater Cover** | As cover, but a +4 bonus. |

When you're behind an obstacle that could block weapons, guard you against explosions, and make you harder to detect, you're behind cover. Standard cover gives you a +2 circumstance bonus to AC, to Reflex saves against area effects, and to Stealth checks to [[content/0. DM Screen/Rules/PF2E/actions/hide]], [[sneak]], or otherwise avoid detection. You can increase this to greater cover using the [[Take Cover]] basic action, increasing the circumstance bonus to +4. If cover is especially light, typically when it's provided by a creature, you have lesser cover, which grants a +1 circumstance bonus to AC. A creature with standard cover or greater cover can attempt to use Stealth to [[content/0. DM Screen/Rules/PF2E/actions/hide]], but lesser cover isn't sufficient.
