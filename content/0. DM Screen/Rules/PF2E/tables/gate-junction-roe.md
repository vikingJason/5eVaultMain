...
|----------------------|
| **Critical Blast** If the target is on the ground, it's knocked [prone](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Prone); if it isn't on the ground, it descends up to 20 feet (you choose the distance). |
...
| Fire Gate Junctions |
|---------------------|
| **Critical Blast** The target takes `1d6` [persistent fire damage](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage). You gain an item bonus to this [persistent damage](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage) equal to your item bonus to impulse attack rolls, such as from a gate attenuator. |
...
|----------------------|
| **Critical Blast** The target takes `1d6` [persistent bleed damage](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage); if the creature has the metal trait or is made of metal, it instead takes `1d6` [persistent damage](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage) with no type from rust. You gain an item bonus to this [persistent damage](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage) equal to your item bonus to impulse attack rolls, such as from a gate attenuator. |
...
| Wood Gate Junctions |
|---------------------|
| **Critical Blast** If the target of the critical hit is adjacent to a surface, roots entangle it. The target is [immobilized](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Immobilized) and must spend an [Interact](rules/actions/interact.md) action to attempt a DC 10 [Athletics](compendium/skills.md#Athletics) check to pull itself free. The target doesn't become stuck if it is incorporeal, is liquid, or could otherwise escape without effort. |
