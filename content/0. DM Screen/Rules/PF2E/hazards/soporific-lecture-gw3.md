...
Several [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) nozzles spray colorless sleeping gas into the seating area.

- **Disable** DC 28 [Thievery](compendium/skills.md#Thievery) (expert) to crimp shut the primary feeding tube for the gas, or DC 31 [Perception](compendium/skills.md#Perception) (expert) to discover the [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) bypass switch next to the door to area A3 that shuts the trap off  
