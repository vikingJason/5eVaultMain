...
- **Complexity** Simple
- **Stealth** DC 18 (or 0 if the trapdoor is disabled or [broken](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Broken))  
...
**Reset** Creatures can still fall into the trap, but the trapdoor must be reset manually for the trap to become [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) again.  
