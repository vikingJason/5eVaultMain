...
- **Disable** three DC 31 [Thievery](compendium/skills.md#Thievery) (expert) checks to a Device to disable the latches that lock the nozzle in place, then one DC 35 [Thievery](compendium/skills.md#Thievery) (master) check to a Device to turn off the nozzle; DCs decrease by 2 if Oggvurm is [immobilized](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Immobilized), [paralyzed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Paralyzed), [unconscious](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Unconscious), or dead.  
