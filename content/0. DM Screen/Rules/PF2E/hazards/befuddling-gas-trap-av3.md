...
- **Complexity** Complex
- **Stealth** +21 expert or DC 31 (expert) to notice the [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) override mechanism on the north wall.  

Seven nozzles [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) within holes in the 15-foot-high ceiling release a poison gas.

- **Disable** DC 33 [Thievery](compendium/skills.md#Thievery) (master) to disable the [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) mechanism on the north wall, immediately sucking the gas from the room, or DC 29 [Thievery](compendium/skills.md#Thievery) (expert) to adequately plug one of the seven nozzles. When all seven nozzles are plugged or destroyed, the trap is deactivated.  
