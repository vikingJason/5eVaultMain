...
- **Disable** three DC 40 [Thievery](compendium/skills.md#Thievery) (legendary) checks or castings of [dispel magic](compendium/spells/dispel-magic.md) (7th level; counteract DC 40), one each to pull out or disable the elemental cores [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) in the floating skull's right eye, left eye, and mouth  
