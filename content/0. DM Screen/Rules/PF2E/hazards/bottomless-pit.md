...
- **Complexity** Simple
- **Stealth** DC 30 (or 0 if the trapdoor is disabled or [broken](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Broken)) or [detect magic](compendium/spells/detect-magic.md).  
...
**Reset** The trap still causes creatures to fall forever if they fall in, but the trapdoor must be reset manually for the trap to become [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) again.  
