...
- **Disable** DC 20 [Thievery](compendium/skills.md#Thievery) (trained) to remove the trapdoor or lock it in position using a catch [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) inside the room's doorframe.  
