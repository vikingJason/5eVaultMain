...
Sometimes you'll need to halve or double an amount of damage, such as when the outcome of your Strike is a critical hit, or when you succeed at a basic Reflex save against a spell. When this happens, you roll the damage normally, adding all the normal modifiers, bonuses, and penalties. Then you double or halve the amount as appropriate (rounding down if you halved it). The GM might allow you to roll the dice twice and double the modifiers, bonuses, and penalties instead of doubling the entire result, but this usually works best for singletarget attacks or spells at low levels when you have a small number of damage dice to roll. Benefits you gain specifically from a critical hit, like the [flaming](compendium/equipment/items/flaming.md) weapon rune's [persistent fire damage](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage) or the extra damage die from the fatal weapon trait, aren't doubled.
...
> 
> **[Blinded](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Blinded):** You're unable to see.
> 
> **[Broken](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Broken):** This item can't be used for its normal function until repaired.
> 
> **[Clumsy](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Clumsy):** You can't move as easily or gracefully as usual.
> 
> **[Concealed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Concealed):** Fog or similar obscuration makes you difficult to see and target.
> 
> **[Confused](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Confused):** You attack indiscriminately.
> 
> **[Controlled](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Controlled):** Another creature determines your actions.
> 
> **[Dazzled](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dazzled):** Everything is [concealed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Concealed) to you.
> 
> **[Deafened](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Deafened):** You're unable to hear.
> 
> **[Doomed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Doomed):** With your soul in peril, you are now closer to death.
> 
> **[Drained](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Drained):** Blood loss or something similar has leached your vitality.
> 
> **[Dying](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dying):** You're slipping closer to death.
> 
> **[Encumbered](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Encumbered):** You're carrying more weight than you can manage.
> 
> **[Enfeebled](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Enfeebled):** Your strength has been sapped away.
> 
> **[Fascinated](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Fascinated):** You are compelled to focus your attention on something.
> 
> **[Fatigued](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Fatigued):** Your defenses are lower and you can't focus while exploring.
> 
> **[Flat-Footed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Flat-footed):** You're unable to defend yourself to your full capability.
> 
> **[Fleeing](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Fleeing):** You must run away.
> 
> **[Friendly](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Friendly):** An NPC with this condition has a good attitude toward you.
> 
> **[Frightened](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Frightened):** Fear makes you less capable of attacking and defending.
> 
> **[Grabbed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Grabbed):** A creature, object, or magic holds you in place.
> 
> **[Helpful](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Helpful):** An NPC with this condition wants to assist you.
> 
> **[Hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden):** A creature you're [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) from knows your location but can't see you.
> 
> **[Hostile](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hostile):** An NPC with this condition wants to harm you.
> 
> **[Immobilized](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Immobilized):** You can't move.
> 
> **[Indifferent](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Indifferent):** An NPC with this condition doesn't have a strong opinion about you.
> 
> **[Invisible](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Invisible):** Creatures can't see you.
> 
> **[Observed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Observed):** You're in plain view.
> 
> **[Paralyzed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Paralyzed):** You body is frozen in place.
> 
> **[Persistent Damage](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage):** You keep taking damage every round.
> 
> **[Petrified](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Petrified):** You've been turned to stone.
> 
> **[Prone](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Prone):** You're lying on the ground and easier to attack.
> 
> **[Quickened](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Quickened):** You get an extra action each turn.
> 
> **[Restrained](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Restrained):** You're tied up and can't move, or a grappling creature has you pinned.
> 
> **[Sickened](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Sickened):** You're sick to your stomach.
> 
> **[Slowed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Slowed):** You lose actions each turn.
> 
> **[Stunned](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Stunned):** You can't use actions.
> 
> **[Stupefied](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Stupefied):** Your can't access your full mental faculties, and you have trouble casting spells.
> 
> **[Unconscious](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Unconscious):** You're asleep or knocked out.
> 
> **[Undetected](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Undetected):** A creature you're [undetected](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Undetected) by doesn't know where you are.
> 
> **[Unfriendly](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Unfriendly):** An NPC with this condition doesn't like you.
> 
> **[Unnoticed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Unnoticed):** A creature is entirely unaware you're present.
> 
> **[Wounded](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Wounded):** You've been brought back from the brink of death but haven't fully recovered.
...
- You gain the [dying](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dying) condition. If the effect that knocked you out was a critical success from the attacker or the result of your critical failure, you gain the [dying](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dying) condition instead. If you have the [wounded](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Wounded) condition (page 460), increase your [dying](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dying) value by an amount equal to your [wounded](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Wounded) value. If the damage was dealt by a nonlethal attack or nonlethal effect, you don't gain the dying condition; you are instead unconscious with 0 Hit Points.
...
> [!success-degree] 
> - **Critical Success** Your [dying](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dying) value is reduced by 2.
> - **Success** Your [dying](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dying) value is reduced by 1.
> - **Failure** Your [dying](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dying) value increases by 1.
> - **Critical Failure** Your [dying](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dying) value increases by 2.
...
Presented below are the rules for the [dying](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dying), [unconscious](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Unconscious), wounded, and doomed conditions.
...
You take a –4 status penalty to AC, Perception, and Reflex saves, and you have the blinded and [flat-footed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Flat-footed) conditions.

When you gain this condition, you fall [prone](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Prone) and drop items you are wielding or holding unless the effect states otherwise or the GM determines you're in a position in which you wouldn't.

**If you're [unconscious](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Unconscious) because you're [dying](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dying)**, you can't wake up as long as you have 0 Hit Points. If you're restored to 1 Hit Point or more via healing, you lose the dying and unconscious conditions and can act normally on your next turn.

If you are [unconscious](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Unconscious) and at 0 Hit Points, but not **dying**, you naturally return to 1 Hit Point and awaken after sufficient time passes. The GM determines how long you remain unconscious, from a minimum of 10 minutes to several hours. If you receive healing during this time, you lose the unconscious condition and can act normally on your next turn.

If you're [unconscious](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Unconscious) and have more than 1 Hit Point (typically because you are asleep or unconscious due to an effect), you wake up in one of the following ways.

Each causes you to lose the [unconscious](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Unconscious) condition.

- You take damage, provided the damage doesn't reduce you to 0 Hit Points. (If the damage reduces you to 0 Hit Points, you remain [unconscious](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Unconscious) and gain the [dying](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dying) condition as normal.)
...
If you have a climb Speed, you're not [flat-footed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Flat-footed) while climbing.
...
In bright light, such as sunlight, creatures and objects can be observed clearly by anyone with average vision or better. Some types of creatures are [dazzled](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dazzled) or [blinded](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Blinded) by bright light.

#### Dim Light
<sup>CRB p. 464</sup>

Areas in shadow or lit by weak light sources are in dim light. Creatures and objects in dim light have the [concealed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Concealed) condition, unless the seeker has [darkvision](rules/abilities/darkvision.md) or [low-light vision](rules/abilities/low-light-vision.md), or a 0 other than vision.

#### Darkness
<sup>CRB p. 464</sup>

A creature or object within darkness is hidden or undetected unless the seeker has [darkvision](rules/abilities/darkvision.md) or a 0 other than vision. A creature without [darkvision](rules/abilities/darkvision.md) or another means of perceiving in darkness has the [blinded](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Blinded) condition while in darkness, though it might be able to see illuminated areas beyond the darkness. If a creature can see into an illuminated area, it can observe creatures within that illuminated area normally. After being in darkness, sudden exposure to bright light might make you [dazzled](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dazzled) for a short time, as determined by the GM.
...
Hearing is an imprecise sense—it cannot detect the full range of detail that a 0 can. You can usually sense a creature automatically with an imprecise sense, but it has the [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) condition instead of the [observed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Observed) condition. It might be [undetected](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Undetected) by you if it's using [Stealth](compendium/skills.md#Stealth) or is in an environment that distorts the sense, such as a noisy room in the case of hearing. In those cases, you have to use the [Seek](rules/actions/seek.md) basic action to detect the creature. At best, an imprecise sense can be used to make an [undetected](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Undetected) creature (or one you didn't even know was there) merely [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden)—it can't make the creature [observed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Observed).

#### Vague Senses
<sup>CRB p. 465</sup>

A character also has many vague senses—ones that can alert you that something is there but aren't useful for zeroing in on it to determine exactly what it is. The most useful of these for a typical character is the sense of smell. At best, a vague sense can be used to detect the presence of an [unnoticed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Unnoticed) creature, making it [undetected](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Undetected). Even then, the vague sense isn't sufficient to make the creature [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) or [observed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Observed).
...
A creature with [low-light vision](rules/abilities/low-light-vision.md) can see in dim light as though it were bright light, so it ignores the [concealed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Concealed) condition due to dim light.
...
With the exception of [invisible](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Invisible), these conditions are relative to the viewer—it's possible for a creature to be observed to you but hidden from your ally. When you're trying to target a creature that's hard to see or otherwise sense, various drawbacks apply. Most of these rules apply to objects you're trying to detect as well as creatures.
...
You can attempt to avoid detection by using the [Stealth](compendium/skills.md#Stealth) skill to [Avoid Notice](rules/actions/avoid-notice.md), [Hide](content/0.%20DM%20Screen/Rules/Rules/Actions/Hide.md), or [Sneak](rules/actions/sneak.md), or by using [Deception](compendium/skills.md#Deception) to [Create a Diversion](rules/actions/create-a-diversion.md).

#### Observed
<sup>CRB p. 466</sup>

In most circumstances, you can sense creatures without difficulty and target them normally. Creatures in this state are observed. Observing requires a precise sense, which for most creatures means sight, but see the Detecting with Other Senses sidebar for advice regarding creatures that don't use sight as their primary sense. If you can't observe the creature, it's either [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden), [undetected](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Undetected), or [unnoticed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Unnoticed), and you'll need to factor in the targeting restrictions. Even if a creature is [observed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Observed), it might still be [concealed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Concealed).

#### Hidden
<sup>CRB p. 466</sup>

A creature that's hidden is only barely perceptible. You know what space a hidden creature occupies, but little else. Perhaps the creature just moved behind cover and successfully used the Hide action. Your target might be in a deep fogbank or behind a waterfall, where you can see some movement but can't determine an exact location. Maybe you've been [blinded](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Blinded) or the creature is under the effects of [invisibility](compendium/spells/invisibility.md), but you used the [Seek](rules/actions/seek.md) basic action to determine its general location based on hearing alone. Regardless of the specifics, you're [flat-footed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Flat-footed) to a hidden creature.

When targeting a [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) creature, before you roll to determine your effect, you must attempt a DC 11 flat check. If you fail, you don't affect the creature, though the actions you used are still expended—as well as any spell slots, costs, and other resources. You remain [flat-footed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Flat-footed) to the creature, whether you successfully target it or not.

#### Undetected
<sup>CRB p. 466</sup>

If a creature is undetected, you don't know what space it occupies, you're [flat-footed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Flat-footed) to it, and you can't easily target it. Using the [Seek](rules/actions/seek.md) basic action can help you find an undetected creature, usually making it [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) from you instead of [undetected](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Undetected). If a creature is [undetected](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Undetected), that doesn't necessarily mean you're unaware of its presence—you might suspect an [undetected](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Undetected) creature is in the room with you, even though you're unable to find its space. The [unnoticed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Unnoticed) condition covers creatures you're entirely unaware of.

Targeting an [undetected](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Undetected) creature is difficult. If you suspect there's a creature around, you can pick a square and attempt an attack. This works like targeting a [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) creature, but the flat check and attack roll are both rolled in secret by the GM. The GM won't tell you why you missed—whether it was due to failing the flat check, rolling an insufficient attack roll, or choosing the wrong square. The GM might allow you to try targeting an undetected creature with some spells or other abilities in a similar fashion. [Undetected](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Undetected) creatures are subject to area effects normally.
...
When you target a creature that's [concealed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Concealed) from you, you must attempt a DC 5 flat check before you roll to determine your effect. If you fail, you don't affect the target. the [concealed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Concealed) condition doesn't change which of the main categories of detection apply to the creature. A creature in a light fog bank is still observed even though it's concealed.

### Invisible
<sup>CRB p. 467</sup>

A creature with the invisible condition (by way of an [invisibility](compendium/spells/invisibility.md) spell or [invisibility potion](compendium/equipment/items/invisibility-potion.md), for example) is automatically [undetected](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Undetected) to any creatures relying on sight as their only precise sense. Precise senses other than sight ignore the invisible condition.

You can use the [Seek](rules/actions/seek.md) basic action to attempt to figure out an [invisible](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Invisible) creature's location, making it instead only [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) from you. This lasts until the [invisible](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Invisible) creature successfully uses [Sneak](rules/actions/sneak.md) to become [undetected](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Undetected) again. If you're already [observing](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Observed) a creature when it becomes [invisible](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Invisible), it starts out [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden), since you know where it was when it became [invisible](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Invisible), though it can then [Sneak](rules/actions/sneak.md) to become [undetected](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Undetected).

Other effects might make an [invisible](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Invisible) creature hidden or even observed but concealed. For instance, if you were tracking an invisible creature's footprints through the snow, the footprints would make it hidden.

Similarly, throwing a net over an [invisible](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Invisible) creature would make it [observed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Observed) but [concealed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Concealed) for as long as the net is on the creature.
...
- **Spend all your Hero Points** (minimum 1) to avoid death. You can do this when your [dying](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dying) condition would increase. You lose the [dying](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dying) condition entirely and stabilize with 0 Hit Points. You don't gain the [wounded](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Wounded) condition or increase its value from losing the [dying](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dying) condition in this way, but if you already had that condition, you don't lose it or decrease its value.
...
- If you're [dying](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Dying), roll a recovery check (page 459).
...
- Regain your 3 actions and 1 reaction. If you haven't spent your reaction from your last turn, you lose it—you can't "save" actions or reactions from one turn to use during the next turn. If a condition prevents you from being able to act, you don't regain any actions or your reaction. Some abilities or conditions (such as [quickened](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Quickened) and [slowed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Slowed)) can change how many actions you regain and whether you regain your reaction. If you lose actions and gain additional actions (such as if you're both [quickened](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Quickened) and [slowed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Slowed)), you choose which actions to lose.
...
- If you have a [persistent damage](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage) condition, you take the damage at this point. After you take the damage, you can attempt the flat check to end the [persistent damage](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage). You then attempt any saving throws for ongoing afflictions. Many other conditions change at the end of your turn, such as the [frightened](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Frightened) condition decreasing in severity. These take place after you've taken any [persistent damage](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage), attempted flat checks to end the [persistent damage](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage), and attempted saves against any afflictions.
...
A narrow surface is so precariously thin that you need to [Balance](rules/actions/balance.md) or risk falling. Even on a success, you are [flat-footed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Flat-footed) on a narrow surface.
...
Uneven ground is an area unsteady enough that you need to [Balance](rules/actions/balance.md) or risk falling prone and possibly injuring yourself, depending on the specifics of the uneven ground. You are [flat-footed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Flat-footed) on uneven ground. Each time you are hit by an attack or fail a save on uneven ground, you must succeed at a Reflex save (with the same DC as the [Acrobatics](compendium/skills.md#Acrobatics) check to Balance) or fall prone.
...
You're [flat-footed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Flat-footed) when [Climbing](rules/actions/climb.md) an incline.

### Flanking
<sup>CRB p. 476</sup>

When you and an ally are flanking a foe, it has a harder time defending against you. A creature is [flat-footed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Flat-footed) (taking a –2 circumstance penalty to AC) to melee attacks from creatures that are flanking it.
...
When you're behind an obstacle that could block weapons, guard you against explosions, and make you harder to detect, you're behind cover. Standard cover gives you a +2 circumstance bonus to AC, to Reflex saves against area effects, and to [Stealth](compendium/skills.md#Stealth) checks to [Hide](content/0.%20DM%20Screen/Rules/Rules/Actions/Hide.md), [Sneak](rules/actions/sneak.md), or otherwise avoid detection. You can increase this to greater cover using the [Take Cover](rules/actions/take-cover.md) basic action, increasing the circumstance bonus to +4. If cover is especially light, typically when it's provided by a creature, you have lesser cover, which grants a +1 circumstance bonus to AC. A creature with standard cover or greater cover can attempt to use [Stealth](compendium/skills.md#Stealth) to [Hide](content/0.%20DM%20Screen/Rules/Rules/Actions/Hide.md), but lesser cover isn't sufficient.
...
- You're [flat-footed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Flat-footed) unless you have a swim Speed.
...
You perform at your best when you take enough time to rest and prepare. Once every 24 hours, you can take a period of rest (typically 8 hours), after which you regain Hit Points equal to your Constitution modifier (minimum 1) times your level, and you might recover from or improve certain conditions (page 453). Sleeping in armor results in poor rest that leaves you [fatigued](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Fatigued). If you go more than 16 hours without resting, you become [fatigued](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Fatigued) (you cannot recover from this until you rest at least 6 continuous hours).
