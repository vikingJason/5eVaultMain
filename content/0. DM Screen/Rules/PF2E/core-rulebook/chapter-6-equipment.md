...
> 
> You are carrying more weight than you can manage. While you're [encumbered](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Encumbered), you're [clumsy](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Clumsy) and take a –10-foot penalty to all your Speeds. As with all penalties to your Speed, this can't reduce your Speed below 5 feet.
...
**Dart:** The target takes `1d6` [persistent bleed damage](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage). You gain an item bonus to this bleed damage equal to the weapon's item bonus to attack rolls.

**Flail:** The target is knocked [prone](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Prone).

**Hammer:** The target is knocked [prone](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Prone).

**Knife:** The target takes `1d6` [persistent bleed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage) damage. You gain an item bonus to this bleed damage equal to the weapon's item bonus to attack rolls.
...
**Sword:** The target is made off-balance by your attack, becoming [flat-footed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Flat-footed) until the start of your next turn.
...
**Caltrops:** These four-pronged metal spikes can cause damage to a creature's feet. You can scatter caltrops in an empty square adjacent to you with an Interact action. The first creature that moves into that square must succeed at a DC 14 [Acrobatics](compendium/skills.md#Acrobatics) check or take 1d4 piercing damage and 1 [persistent bleed damage](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage). A creature taking [persistent bleed damage](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage) from caltrops takes a –5-foot penalty to its Speed. Spending an Interact action to pluck the caltrops free reduces the DC to stop the bleeding. Once a creature takes damage from caltrops, enough caltrops are ruined that other creatures moving into the square are safe.
...
**Lesser Acid Flask:** This alchemical bomb deals 1 acid damage, `1d6` [persistent acid damage](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage), and 1 acid [splash](rules/traits/splash.md "Splash Weapon Trait") damage.

**Lesser Alchemist's Fire:** This alchemical bomb deals 1d8 fire damage, 1 [persistent fire damage](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Persistent%20Damage), and 1 fire [splash](rules/traits/splash.md "Splash Weapon Trait") damage.

**Lesser Bottled Lightning:** This alchemical bomb deals `1d6` electricity damage and 1 electricity [splash](rules/traits/splash.md "Splash Weapon Trait") damage, and it makes the target [flat-footed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Flat-footed).
...
**Lesser Tanglefoot Bag:** This alchemical bomb gives the target a –10-foot status penalty to its Speeds for 1 minute, and the target is immobilized on a critical hit unless it [Escapes](content/0.%20DM%20Screen/Rules/Actions/Escape.md).
...
The Prices for animals are listed both for renting and for purchasing them outright. You usually need to pay for animal rentals up front, and if the vendor believes the animal might be put in danger, they typically require a deposit equal to the purchase Price. Most animals panic in battle. When combat begins, they become [frightened](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Frightened) and [fleeing](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Fleeing) as long as they're [frightened](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Frightened). If you successfully Command your Animal using [Nature](compendium/skills.md#Nature), you can keep it from fleeing, though this doesn't remove its frightened condition. If the animal is attacked or damaged, it returns to [frightened](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Frightened) and [fleeing](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Fleeing), with the same exceptions.

Warhorses and warponies are combat trained. They don't become [frightened](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Frightened) or [fleeing](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Fleeing) during encounters in this way.
