...
> [!success-degree] 
> - **Success** You become hidden to each creature whose [Perception](compendium/skills.md#Perception) DC is less than or equal to your result. (The [hidden](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hidden) condition allows you to [Sneak](rules/actions/sneak.md) away, as described on page 252.) This lasts until the end of your turn or until you do anything except [Step](rules/actions/step.md) or use the [Hide](content/0.%20DM%20Screen/Rules/Rules/Actions/Hide.md) or the [Sneak](rules/actions/sneak.md) action of the [Stealth](compendium/skills.md#Stealth) skill. If you [Strike](rules/actions/strike.md) a creature, the creature remains [flat-footed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Flat-footed) against that attack, and you then become [observed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Observed). If you do anything else, you become [observed](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Observed) just before you act unless the GM determines otherwise.
