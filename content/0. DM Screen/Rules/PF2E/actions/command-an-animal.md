...
You automatically fail if the animal is [hostile](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Hostile) or [unfriendly](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Unfriendly) to you. If the animal is [helpful](content/0.%20DM%20Screen/Rules/Conditions/Conditions.md#Helpful) to you, increase your degree of success by one step. You might be able to Command an Animal more easily with a feat like [Ride](compendium/feats/ride.md).
