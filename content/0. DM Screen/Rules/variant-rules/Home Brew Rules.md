...
| 4-5       | The creature is [[content/0. DM Screen/Rules/Conditions/Stunned]] until the end of its next turn.              |
...
When a creature makes a melee attack, it can also mark its target. Until the end of the attacker's next turn, any opportunity attack it makes against the marked target has advantage. The opportunity attack doesn't expend the attacker's reaction, but the attacker can't make the attack if anything, such as the [[content/0. DM Screen/Rules/Conditions/Incapacitated]] condition or the [[shocking grasp]] spell, is preventing it from taking reactions. The attacker is limited to one opportunity attack per turn.
...
#### Shove Aside
With this option, a creature uses the special [[content/0. DM Screen/Rules/PF2E/traits/shove]] attack from the "Player's Handbook" to force a target to the side, rather than away. The attacker has disadvantage on its Strength ([[Athletics - Strength]]) check when it does so. If that check is successful, the attacker moves the target 5 feet to a different space within its reach.
...
If you are at least 5 feet below your target, your target is your size or smaller, and you aren't [[content/0. DM Screen/Rules/Conditions/Grappled]] or [[content/0. DM Screen/Rules/Conditions/Restrained]], you gain an expertise die on [[Strength]] checks and saving throws made against it.
