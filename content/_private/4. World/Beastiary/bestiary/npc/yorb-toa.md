...
- "Yorb"
---
# [Yorb](CLI/bestiary/npc/yorb-toa.md)
...
"traits":
  ...
  - "desc": "Any creature that grapples Yorb or otherwise comes into direct contact\
      ...
      \ Yorb can repeat the saving throw at the end of each of its turns, ending the\
...
"actions":
  ...
  - "desc": "Yorb makes a chirring noise to which grungs are immune. Each humanoid\
      ...
      \ a DC 12 Wisdom saving throw or be stunned until the end of Yorb's next turn."
    "name": "Mesmerizing Chirr (Recharge 6)"
"source":
  - "ToA"
"image": "CLI/bestiary/npc/token/yorb-toa.webp"
```
^statblock