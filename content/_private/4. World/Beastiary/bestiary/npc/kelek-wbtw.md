...
- "Kelek"
---
# [Kelek](CLI/bestiary/npc/kelek-wbtw.md)
...
"actions":
  ...
  - "desc": "Kelek casts one of the following spells, using Charisma as the spellcasting\
    ...
    "name": "Spellcasting"
"reactions":
  - "desc": "When he is hit by an attack, Kelek protects himself with an invisible\
...
"source":
  - "WBtW"
"image": "CLI/bestiary/npc/token/kelek-wbtw.webp"
```
^statblock