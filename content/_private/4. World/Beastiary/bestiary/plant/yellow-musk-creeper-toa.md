...
- "Yellow Musk Creeper"
---
# [Yellow Musk Creeper](CLI/bestiary/plant/yellow-musk-creeper-toa.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +3 to hit, reach 5 ft., one creature. *Hit:*\
      ...
      \ musk zombie, or if the corpse is targeted by a remove curse spell or similar\
  ...
  - "desc": "The creeper's flowers release a strong musk that targets all humanoids\
      ...
      \ or be charmed by the creeper for 1 minute. A creature charmed in this way\
      \ does nothing on its turn except move as close as it can to the creeper. A\
      \ creature charmed by the creeper can repeat the saving throw at the end of\
      \ each of its turns, ending the effect on itself on a success."
    "name": "Yellow Musk (3/Day)"
"source":
  - "ToA"
"image": "CLI/bestiary/plant/token/yellow-musk-creeper-toa.webp"
```
^statblock