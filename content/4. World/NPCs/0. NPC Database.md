...
columns:
  ...
  Alignment:
    ...
    options:
      ...
      - { label: "[[3. Mechanics/Alignments/Neutral Evil.md|Neutral Evil]]", value: "[[3. Mechanics/Alignments/Neutral Evil.md|Neutral Evil]]", color: "hsl(16, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Race:
    ...
    options:
      ...
      - { label: "Half-orc", value: "Half-orc", color: "hsl(77, 95%, 90%)"}
      - { label: "Drow", value: "Drow", color: "hsl(170, 95%, 90%)"}
      - { label: "[[3. Mechanics/Races/Elf.md|Elf]]", value: "[[3. Mechanics/Races/Elf.md|Elf]]", color: "hsl(198, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Age:
    ...
    options:
      ...
      - { label: "Teenager", value: "Teenager", color: "hsl(251, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Occupation:
    ...
    options:
      ...
      - { label: "Acrobat", value: "Acrobat", color: "hsl(132, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  AssociatedGroup:
    ...
    options:
      ...
      - { label: "Purple Dragons", value: "Purple Dragons", color: "hsl(97, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Type:
    ...
    options:
      ...
      - { label: "NPCTable", value: "NPCTable", color: "hsl(187, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
