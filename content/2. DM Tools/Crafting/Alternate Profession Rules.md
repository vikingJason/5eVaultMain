...
There are two primary methods of plying a trade while practicing various professions. One is by setting up a place of business in a static location, and the other is by traveling from point to point, offering services. Both of these approaches are possible within a single area of expertise in almost every case, though there are advantages and disadvantages inherent in each. The Profession rules as written do not take any of this into account.
