...
## Step 1: How It’s Made - Basic Rules
...
| --------------- | ------- |
| Success |Finish now by spending the other half of the cost<br> **OR** <br>Continue working to reduce cost as if Earning Income each day |
...
### Consumable Items
Items such as bombs, scrolls, potions, and talismans can be made in Batches of 4. You must still pay the cost of materials for all of them, but this is more efficient than crafting one potion at a time. 
...
- An Alchemist’s Lab is needed to craft alchemical items during downtime. An Alchemist, Investigator, or similar character only needs Alchemist’s Tools to use their daily class features.
- A Snare Kit has all the necessary tools for creating snares through downtime and special abilities.
...
### Reverse Engineer
If you have the item but not the formula, you can spend 2 Days disassembling the item to discover the recipe. At the end of the two days, make a Crafting check against the DC to create the item. No benefit is listed for critical success, but I would recommend being treated as 1 level higher when earning income.



|Crafting Result | Effects|
|---|---|
| Success | Pay the cost of the formula to learn it now OR<br><br>continue working to pay it off through Earn Income. This can reduce the cost to 0. |
...
### Check DC: Assurance vs Intelligence
...
#### Item Bonus
Better quality tool kits and magic items can provide an Item Bonus on Crafting checks. The earliest level at which these appear is 3rd (+1), 9th (+2), and 17th (+3). These won’t help with the Assurance feat, but any character actually rolling their checks should seek these out as soon as they can. Crafting gear is discussed further in the character building chapter.

#### Status Bonus
Spells and effects such as Guidance and Heroism grant a Status bonus on skill checks. Due to their short duration, it is difficult to get this bonus on downtime checks. The rules require that a bonus be constant or applied so frequently that it is effectively constant.

#### Rerolls
Things like Hero Points or Halfling Luck cannot be used during downtime activities. This reinforces the fact that you only get one roll. Better make it count.
...
## Step 2: Get That Bread - Other Uses
...
#### Recall Knowledge
An untrained character can use Crafting to perform any of the functions of the old Appraise and Knowledge Engineering skills. This includes determining the value of an item, understanding how trap mechanisms work, the traits of unusual materials, and identifying alchemical or mechanical monsters such as constructs.

#### Identify Alchemy
A Trained character with an Alchemist Kit can spend 10 minutes testing the properties of an alchemical item to understand what it does. This requires a Craft check with a DC set by the GM (I would recommend using the item’s level). On a critical failure you incorrectly identify the item as doing something else.

#### Obstacles & Hazards
Crafting is listed as an alternative to Athletics and other skill checks when resolving certain obstacles and hazards. Usually this involves things like repairing a rope bridge or reinforcing an unstable mineshaft or corridor.

#### Piloting Vehicles
Crafting is the primary skill check used to pilot Alchemical vehicles such as airships and steam giants. The Gamemastery Guide doesn’t explicitly say players can craft or repair vehicles, but it does list their level and price, which is all you need to determine their DC.
Rituals: Several rituals require a secondary caster to make a Crafting check; Planar Binding, Animate Object, Consecrate, Imprisonment, and Primal Call. 

## Step 3: Equipment Categories - What Can You Make?
...
### ADVENTURING GEAR
All mundane equipment that can be crafted by anyone Trained in Crafting. With the exception of high level locks and manacles, most of this gear is level 0-3. Some of it is so cheap and minor (such as pieces of chalk) that it should probably be done during a rest or morning preparation instead of using the Craft system.
#### Armor
This includes mundane armor, unique magic armor, and armor made of precious materials like mithral. We’ll discuss precious materials later on.
#### Shields
These include your basic shields, special material shields, and unique magic shields.
#### Weapons
This includes mundane weapons, unique magic weapons, and those made of precious materials like mithral. We’ll discuss precious materials later on.

### ALCHEMICAL ITEMS
These all require the Alchemical Crafting feat and an Alchemist Lab when created during downtime. Classes such as Alchemist and Investigator can create these items for free during their daily preparation with an Alchemist Kit. Most of these count as Consumables and can be made in batches.
#### Bombs
Most bombs deal damage and sometimes splash, but some have other effects.
#### Bullets
Firearm ammunition uses black powder or other alchemical components. 
#### Elixirs
Non-magical potions that typically provide healing and temporary buffs.
#### Poisons
Put these on your weapons or feed them to someone you don’t like.
#### Tools
Classic D&D items like the Tindertwig and Sunrod, as well as new items.

### CONSUMABLES
This is a broad category that covers any magic item that is destroyed or worthless after being used. Most of these require the Magical Crafting feat and can all be crafted in batches of 4. In addition to the categories listed here, a few other magic items like Feather Tokens also count as consumables.
#### Ammunition
Mundane ammunition can be crafted in batches of 10, while magic ammunition follows the normal batch of 4. Firearm bullets require the Alchemical Crafting feat, but otherwise follow the same rules as other ammo.
#### Fulus
Magical sticky notes that activate based on a certain trigger. Interestingly, fulus can be crafted in 1 day instead of 2. This reduces their duration from 1 year to 1 month.
#### Gadgets
Technological items that produce a one-time effect. Since gadgets are all uncommon or rare, typically only Inventors have easy access to them.
#### Oils
Lotions and ointments that are applied to other gear or characters. Typically they take 1-2 actions to apply and reproduce a spell or provide a temporary effect.
#### Potions
Magical liquids that you drink to gain a temporary benefit. Alchemical Elixirs are similar to potions but are considered non-magical.
#### Scrolls
These parchments are single use copies of a spell. You or an ally will need to cast the spell during the creation of the scroll. There is a formula for each level of scroll, not for each individual spell.
#### Snares
These are small traps that players can create themselves using the Snare Crafting feat. They require only 1 minute to create and set if you have the materials on hand. Crafting a batch during downtime uses the normal Craft rules, so it is usually easier to bring mats and make them on the spot as needed.
#### Talismans
Basically magic key chains and decorations you tie to your weapons and other gear. They can be activated later to provide a one-time bonus.

### RUNES
This is the primary method of enhancing weapons and armor. Runes can be moved from one piece of gear to another so you don’t have to stick with the same item forever. Full rules for runes are described further down.
#### Fundamental
Your standard +1 magical enhancement or increase to damage dice. Also covers armor enhancement and resistance bonuses.
#### Property
Special upgrades for armor and weapons such as Shadow or Bane.
#### Tattoos
While they are inked onto a creature, tattoos function like an invested item. After being crafted, they require a month to heal. Magical or alchemical healing reduces the healing period to 1 day. Requires the Specialty Crafting (Artistry) feat.

### MISCELLANEOUS
These are catch-all categories for various equipment. Each category includes both mundane and magical gear.  
#### Assistive Items
Various mobility aids and prosthetics for characters with impairments. Aside from interesting roleplay opportunities, many of these have other fun applications.
#### Companion Items
Equipment intended for mounts and animal companions.
#### Held Items
Any non-weapon item that needs to be held and manipulated to function. This includes rods, musical instruments, figurines, and bags.
##### Staves
A staff can hold multiple spells related to a theme, like fire or healing. You will need to provide each of the spells listed during the crafting process. Using a staff requires that you can cast spells from that tradition and of that spell level. The number of charges it has are equal to your highest level spell slot. You can’t charge more than one staff each day.
##### Wands
Once per day these can cast a specific spell or produce a special effect. You can try to force a wand to cast again with a flat DC 10 check, but you risk destroying it. When crafting the wand you must supply a spell that meets its crafting requirements.
#### Worn Items
All varieties of clothing accessories like goggles, bracers, boots, and cloaks, as well as jewelry like rings and amulets. Worn Items also collects a few slotless items like aeon stones.
##### Apex Items
These are powerful, endgame versions of old items like Gloves of Dexterity or Periapt of Wisdom. They require using one of your 10 item investment points to bond them to you, which effectively prevents you from easily sharing apex items.

### UNCRAFTABLE
These are additional categories which either can’t be crafted by players or don’t have clear rules on their creation.
#### Artifacts
Items so legendary and rare that they cannot normally be purchased or crafted. Generally these only appear if the GM adds them to the story.
#### Relics
Like Artifacts, relics typically can’t be crafted or found normally. Relics scale in power with the character and allow for more customization and choice. Spellhearts work identical to relics but are inherent to the character and not tied to an object.
#### Structures
Most structures are created using resource points gained via the Kingdom building system. This is a whole separate ruleset that doesn’t interact much with character skills.
#### Vehicles
Most of these are listed in the Gamemastery Guide and range from simple carts and wagons, to galleys and airships. Electric and Clockwork vehicles can be piloted with Crafting.
...
## Step 4: Runes & Precious Materials
...
- Armor Potency: Adds an item bonus to armor class. The number of Property runes you can add to your armor is equal to your Potency (1, 2, or 3).
- Resilient: Adds an item bonus to saving throws. Does not count against your Property runes.
- Weapon Potency: Adds an item bonus to attack rolls. The number of Property runes you can add to your weapon is equal to your Potency (1, 2, or 3).
- Striking: Adds additional damage dice to your weapon, of the same type that weapon uses. Does not count against your Property rune limit. (ex. a striking longsword deals 2d8 damage. A major striking dagger deals 4d4 damage)
...
#### Sturdy Shields
Unlike armor, shields use their own upgrade system called Sturdy. This comes in six tiers and improves the shield’s Hardness, HP, and Break Threshold.
...
#### Runestones
These are 3 gp consumable items that can hold a rune and are destroyed once that rune is transferred to a permanent home. Hint to GMs: Runestones are a great way to hand out upgrades if you don’t want to explain why an ancient dungeon happens to have a better version of the weapons and armor your party likes to use.
...
- Shields: A static cost based on the grade of material and type of shield.
- Tools & Misc: A cost multiplied by the item’s bulk.
- Weapons & Armor: A base cost plus an additional modifier multiplied by the item’s bulk.
...
## Step 5: From The Vault - Alternate Crafting Rules
...
#### Gardening Tools
Rather than using tools for carpentry or smithing, nature crafting will typically use gardening tools. Mechanically, these are still Artisan’s Tools or a similar item. Nature crafting can also substitute playing music instead of physically cultivating a plant. In this instance, the tool is an instrument.
#### Fertilizer
Nature crafting still requires the same cost in materials, but flavored as magical nutrients and accelerants. A character trained in Herbalism Lore can substitute that skill when determining how much value they get each day of extra work, as per the Earn Income table.
#### Seasonal
The wording on this isn’t as clear as I’d like, but as written it seems to give you a bonus day of reducing the cost of an item at the end of each season so long as you put in at least one day of downtime. Assuming a normal season lasts 3 Months of about 30 each, that means you get a bonus day every 90 days. That seems pretty worthless to me, even on gear that takes several months. Hopefully Paizo will provide clarity on this.
#### Alternate Skills
Practically a variant within a variant, GMs can choose to have Nature be the key skill for growing items instead of Crafting. This would create two parallel crafting systems, with one using Intelligence and the other using Wisdom. GMs can further choose to keep Crafting as is or move magical crafting to the Arcana skill. You could also have some gear governed by one or the other. Lots of options to consider.


## Step 6: This Town Ain’t Big Enough - Settlement Level
...
## Step 7: Building a Builder - Character Creation
...
Dwarves
Strangely, the vanilla Core Rules dwarf doesn’t have much synergy with Crafting. Newer splatbooks add several strong options.
Anvil Dwarf (CG). You are automatically trained in Crafting and gain the Specialty Crafting feat for free. What's unique here is they are allowed to pick two specialties. If you later take Impeccable Crafting you can critically succeed with both specialties.
Eye for Treasure (APG), grants training in Crafting (or any skill) and the Crafter’s Appraisal feat.
Dwarven Reinforcement (APG), allows you to temporarily add a small amount of hardness to an item or structure. I don’t think this is worth the time investment.
Battleforger (CG) Allows you to spend an hour to treat your weapon as if it had Potency +1. If you don’t have potency +1 by level 9, something is wrong. Maybe useful for backup weapons.

Elves: Starting with Int boost, elves are an obvious choice for Int-based spellcasting. 
Ageless Patience (Core). This allows elves to spend twice as long on any activity to receive a +2 competence bonus, but more importantly it prevents Critical Failures from natural 1’s on the check. Spending eight days or more on crafting sucks, but critically failing and losing money also sucks. At endgame levels, an elven Int-crafter using Ageless Patience cannot fail.
Ancient Elf (CG). Start the game with a free multiclass feat if you meet the ability-score requirements. Alchemist, Witch, or Wizard are obvious grabs.

Gnomes: Pathfinder gnomes don’t really fill the tinker fantasy from other games.
Inventive Offense. This allows you to temporarily add weapon traits for free. These stay until you hit or change them. Your rank in Crafting reduces the number of actions needed to add a trait.

Goblins: These little guys get the best ancestry feat related to crafting.
Junk Tinker: First, you can craft level 0 items (but not armor), out of trash. This reduces the Price to one-quarter but results in shoddy quality. Thankfully you get to ignore the penalty for shoddy items you created yourself. Second, you can choose to incorporate junk into any other item you create. This grants a discount as if you had spent an extra day crafting. The only downside is that this may affect the item’s value when trying to sell to npcs that hate recycling. If you’re a Goblin crafter I see no reason not to take this wonderful feat.

Halfling - Unfortunately the Halfling Luck feat chain does not work with crafting. 
Intuitive Guidance and Helpful Halfling feats (CG), allow halflings to provide some serious Aid bonuses to the party crafter.

Humans - Easily pick up an Int boost and multiple ways to get important skills and feats.
Skilled Heritage or Versatile Heritage are both solid.
General Training & Advanced General Training will help you specialize in crafting without detracting from your primary build
Cooperative Nature and Cooperative Soul are great choices for assisting the party crafter if you are not crafting yourself.
...
Research Fields: Each specialization of Alchemists corresponds to bombs, elixirs, mutagens, and poisons. Each grants additional formulas and benefits specific to your favored item.
Alchemist Feats: So many of your class feats interact with Alchemical items and crafting that it would take up a whole section by itself. Better to look up a separate Alchemist guide.
Efficient Alchemy: Allows an alchemist to double the number of alchemical items in each batch when crafting during downtime. Usually from 4 to 8. This does not reduce the cost or amount of materials needed, but if you want a load of extra bombs and potions this almost makes it worth your time.
...
Lvl 1 Inventor: You automatically gain the Inventor skill feat much earlier than normal. It’s usefulness still depends on how much downtime is available, but this is a great free bonus.
Built-In-Tools: Allows you to build two sets of tools weighing a total of 2 Bulk or less directly into your minion, weapon, or armor without increasing their weight. A very convenient way to stow your heavy Artisan’s tools.
Reverse Engineer: Allows you to study items to learn their formula, potentially without destroying it. Additionally, you gain the ability to use Crafting in place of Thievery when disabling traps and picking locks.
Lvl 4 Gadget Specialist: Grants you a small number of free gadgets each day based on your Crafting proficiency, along with a handful of formulas. Gadgets are a new type of consumable introduced in Guns & Gears. Like an Alchemist’s potions or bombs, the versatility here is almost as good as getting spell slots. You can invest in this branch further with the Ubiquitous Gadgets and Contingency Gadgets feats.
Lvl 16 Just the Thing! and You Failed to Account for This! are quirky feats that let you pull a made-up invention out of thin air to help resolve a skill check or avoid an attack using your Crafting skill. I would rate these higher because of how fun they are, but they don’t come online until level 16.
...
Lvl 1 Cauldron: Allows you to craft potions and oils in batches of 6 instead of 4. In addition, you automatically learn potion and oil formulas as you level up. Your familiar can retain these for you instead of keeping them in a formula book.
Lvl 10 Temporary Potions: You may create a batch of 2 potions or oils of the same type for free each day. This improves to 3 and 4 if you have Master or Legendary proficiency. 
...
Arcane Thesis: A Staff Nexus wizard should always be investing in Crafting. This is your primary means of upgrading your staff.
Lvl 10 Scroll Savant: Allows you to create free scrolls each morning during your daily preparation. If you are Legendary at Crafting this is like getting 4 extra spell slots.
...
Rackets: The Mastermind and Eldritch Trickster rackets both allow rogues to focus on Intelligence. Notably, an Eldritch Trickster can select Witch Dedication and gain any tradition of spellcasting.
...
Lvl 4 Alchemical Discoveries: This is absolutely vital for alchemical Investigators as it doubles your number of formulas known and grants additional free items based on your Crafting proficiency.
...
Traveling Workshop: This bonkers focus spell belongs to the Crafter in the Vault, granting you training in Crafting and Thievery that scales with your level and provides phantom toolkits for thievery, repair, and alchemy. If you cast the out of combat version, it now lasts 8 hours and summons a phantom alchemist lab and forge. Anywhere. As if that weren’t enough, you are treated as already having any materials needed to repair gear.
What are the limitations? You can’t use this for Earn Income checks and anything you make disappears shortly after leaving your person (consumables and ammo last long enough to take effect). Furthermore, you must stay bound to the Crafter in the Vault until the item sees use in combat. That means if you are making permanent gear it needs to be only for you and preferably a wearable such as an amulet or ring that won’t be removed. Still, this provides huge potential for problem solving without travel.
...
Lvl 4 Snare Specialist: Grants you free formula for common and uncommon snares and lets you prepare a number of snares each day that can be “quick deployed” in 3 actions instead of 1 minute. The number of snares and formula increase with your Crafting proficiency. At level 16 with the Ubiquitous Snares feat, that’s 16 snares.
Lvl 6 Quick Snares: Let's deploy any of your snares in 3 actions, instead of just the ones from your specialist feat. This seems like diminishing returns unless you’re just shooting out snares every round. Lightning Snares upgrades this to 1 action.
Lvl 8 Powerful Snares: Allows you to use your Class DC or the snare’s regular DC. Since Ranger class DC increases slowly, I would not be in a rush to take this. Come back to this once you have Master proficiency or an Apex item.
...
Lvl 1 Munitions Crafter: This feat solves a lot of your problems and is almost as good as the Alchemist Multiclass Archetype. Definitely worth picking up at 1st or 2nd level.
Lvl 6 Munitions Machinist: Upgrades your alchemical skill so you can create higher level bombs and ammo. Sadly, it doesn’t provide any free formulas.
Lvl 10 Precious Munitions: Allows you to spend your infused regents to make ammunition with special metal properties. Automatically upgrades to high-grade at level 15.
...
Eidolons: The dragon and psychopomp eidolons can have a respectable 14 Int and will have an easier time making the skill check.
Lvl 1 Dual Studies: Your eidolon is already trained in all your skills and you should have picked crafting first if you’re even considering this build.
Lvl 4 Skilled Partner: Grants your eidolon two skill feats in case, which is nice because most feats that deal with crafting are skill feats.
...
-----------------
Assassin - Alchemical Crafting; trained in Crafting, Deception, and Stealth
...
Cook Basic Meal - All characters know this action, which is a tough DC 22 Survival or DC 18 Cooking Lore check. Effects last until your morning prep, so typically this is something you’ll want to do at night before sleeping. A success provides a +1 status bonus on all saving throws, while a critical success provides additional healing equal to your Con mod (min 1) x your level during your rest. A critical failure makes everyone sickened until morning, so don’t try this until you can’t roll below 13.
...
Hearty Meal - This recipe is an easier DC 16 Survival or DC 14 Cooking Lore check. Success provides characters with a +1 status bonus on their first saving throw in the next 24 hours, while critical success increases it to three saving throws. Critical failure instead gives everyone that sleepy turkey feeling and they take a -1 penalty on Initiative until their next rest.
A list of other recipes can be found here; https://2e.aonprd.com/CampMeals.aspx
