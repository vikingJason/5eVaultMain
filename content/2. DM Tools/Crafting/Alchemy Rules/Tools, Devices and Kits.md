...
| ------------------------- | ----- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Alchemist’s Lab           | —     | —      | Provides +2 circumstance bonus on Craft (alchemy) checks. Required for the bonus; basic tools alone do not suffice.                                                                           |
| Alchemist’s Lab, Portable | —     | —      | Compact version of a full-sized lab, provides +1 circumstance bonus on Craft (alchemy) checks.                                                                                                |
| Artificer’s Lab, Portable | —     | —      | Allows 4 hours of crafting per night (nets 3 hours of work). Imposes a –5 penalty on skill checks for magic items crafted with it.                                                            |
| Bomb Launcher             | —     | —      | Increases bomb range increment to 30 feet (70 feet for rocket bomb discovery). Destroyed after use.                                                                                           |
| Buoyant Balloon           | 10 gp | 1 lb   | Inflates to a 3-foot sphere, lifting up to 20 lbs (speed reduced to 30 ft/round if carrying over 10 lbs). Floats for 10 minutes or 600 feet before deflating.                                 |
| Candlerod                 | 1 gp  | 1 lb   | Glows like a candle for 12 hours when struck.                                                                                                                                                 |
| Light Detector            | 1 gp  | —      | Metal plate with light-sensitive paste. Darkens based on light exposure: bright light (1 round), normal light (3 rounds), dim light (10 rounds). Used to detect recent light exposure.        |
| Pox Burster               | —     | —      | Splash weapon (10 ft range). Direct hit forces DC 13 Fort save or contracts filth fever. Adjacent squares spread disease for 1 minute (DC 9 Fort save if injured in area).                    |
| Sunrod                    | 2 gp  | 1 lb   | Glows brightly for 6 hours when struck. Sheds normal light in 30 ft radius, increases light level by one step for an additional 30 ft.                                                        |
| Thurible                  | —     | —      | Filled with coal and herbs (2 sp), produces light smoke for 1 hour in a 30-ft diameter area. Grants +2 circumstance bonus on Fortitude saves vs. inhaled diseases.                            |
| Water Purification Sponge | 25 gp | 1 lb   | Absorbs and purifies 1 pint of water per use (full-round action). Cleanses 25 pints before deteriorating. Removes mundane impurities and common diseases, but not poisons or magical threats. |
#### Alchemist’s Lab
