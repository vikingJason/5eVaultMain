...
- **Disable** DC 23 [Thievery](compendium/skills.md#Thievery) (expert) to jam the mechanisms and keep the trapdoor from opening, or to locate the bypass switch [hidden](content/2.%20DM%20Tools/Rules/Conditions/Conditions.md#Hidden) under a stair riser just outside the room.  
