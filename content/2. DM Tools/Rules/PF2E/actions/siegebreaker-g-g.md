...
After the [Strike](rules/actions/strike.md), you become [immobilized](content/2.%20DM%20Tools/Rules/Conditions/Conditions.md#Immobilized) and position the required weapon defensively, gaining a +1 circumstance bonus to AC, or a +2 circumstance bonus if the chosen weapon has the [parry](rules/traits/parry.md "Parry Weapon Trait") trait. Both effects last until the start of your next turn. If a force would move you while you're [immobilized](content/2.%20DM%20Tools/Rules/Conditions/Conditions.md#Immobilized) in this way, it must succeed at an appropriate check against your class DC.