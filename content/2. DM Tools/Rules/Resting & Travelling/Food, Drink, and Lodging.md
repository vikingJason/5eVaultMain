...
| Item                             | Price                       | Weight                          |
| -------------------------------- | --------------------------- | ------------------------------- |
| Absinthe (glass or bottle)       | 3-30 gp                     | — (glass) 1-1/2 lbs. (bottle)   |
| Ale                              | 2 sp                        | 8 lbs.                          |
| Ale                              | 4 cp                        | 1 lb.                           |
| Ale, Dwarven Stout               | 4 cp                        | 1/2 lb.                         |
| Ale, Luglurch                    | 1 gp                        |                                 |
| Ale, Luglurch                    | 4 sp                        |                                 |
| Applejack                        | 4 sp                        | 8 lbs.                          |
| Applejack                        | 8 cp                        | 1 lb.                           |
| Baijiu                           | 10 gp                       | 2 lbs.                          |
| Bufo                             | 1 gp                        | 2 lbs.                          |
| Cauim                            | 1 gp                        | 2 lbs.                          |
| Godsbrew                         | 5 cp                        | 1/2 lb.                         |
| Grog (mug – PPZO9410; cup- PoIS) | 2 cp (PPZO9410) 1 cp (PoIS) | 1/2 lb. (PPZO9410) 1 lb. (PoIS) |
| Kumis                            | 5 sp                        | 1-1/2 lbs.                      |
| Mead (mug)                       | 5 cp                        | 1/2 lb.                         |
| Mead (gallon)                    | 2 gp                        | 8 lbs.                          |
| Mead, linnorm                    | 5 cp                        | 1/2 lb.                         |
| Mead, wasp                       | 400 gp                      | 2 lbs.                          |
| Pulque                           | 1 sp                        | 1/2 lb.                         |
| Rumboozle                        | 1 sp                        | 1/2 lb.                         |
| Tepache                          | 5 cp                        | 1/2 lb.                         |
| Whiskey, Dragon Punch            | 10 gp                       |                                 |
| Whiskey, Oldlaw                  |                             |                                 |
| Wine, common                     | 2 sp                        | 6 lbs.                          |
| Wine, fine                       | 10 gp                       | 1-1/2 lbs.                      |
| Wine, Sangwine                   | 200 gp                      | 2 lbs.                          |
| Wine, sealord                    | 15 gp                       | 1/2 lb.                         |

| Item                   | Price | Weight  |
| ---------------------- | ----- | ------- |
| Coffee, common         | 1 cp  | 1/2 lb. |
| Coffee, exotic         | 3 cp  | 1/2 lb. |
| Coffee, desert         | 2 cp  | 1/2 lb. |
| Coffee, dragon’s blend | 1 gp  | —       |
| Coffee, hybrid         | 1 gp  | —       |
| Coffee, marching       | 1 gp  | —       |
| Milk                   | 5 cp  | 1/2 lb. |
| Milk, powdered         | 1 sp  | 1 lb.   |
| Tea                    | 2 cp  | 1/2 lb. |
| Tea, ceremonial        | 4 cp  | 1/2 lb. |
| Tonic, medicinal       | 10 gp |         |



#### Absinthe

**Price** 3–30 gp; **Weight** varies
...
The recipe for this beer was said to be the last beer imbibed by a god before he undertook a great challenge.
...
Sugar lemons make prized preserves when ground, salted, and sealed in jars, adding an intense citrus flavor when sprinkled atop other foods. If, within 8 hours of consuming a meal seasoned with Sugar lemons, you gain the confused condition, you can roll 1d6 and subtract the result from the result of your d% roll to determine what action you take for the first round in which you are confused. This benefit does not stack with itself.

The price and weight listed represent a jar containing enough preserved lemons to season 10 meals.
...
This deep red wine is highly tannic and has notes of currants and cocoa and an aroma of cedar.

Sangwine is a favorite of the elite, who associate drinking it with long life.
...
The price listed is for a bottle, which contains six glasses’ worth of sangwine.
...
This bitter coffee cultivar increases the drinker’s alertness to nearby threats. For 1 hour after drinking two cups of hybrid coffee, you gain a +2 competence bonus on Perception checks to notice a creature that is using Stealth. You can benefit from hybrid coffee only once per day.
...
| Fees, Tariffs and Tolls                      | Price                              |
| -------------------------------------------- | ---------------------------------- |
| Road or gate toll                            | 1 cp                               |
| Inn stay, good (per night)                   | 2 gp                               |
| Inn stay, common (per night)                 | 5 sp                               |
...
| Contingency Service, harmless risk level     | 3 sp/day                           |
| Contingency Service, questionable risk level | 6 sp/day                           |
| Contingency Service, hazardous risk level    | 1 gp/day                           |
| Contingency Service, deadly risk level       | 3 gp/day                           |
| Contingency Service, suicidal risk level     | 3 pp/day                           |
| Doctor                                       | 1 gp                               |
| Fence                                        | 10%                                |
| Footman                                      | 5 sp                               |
...
*See spell description for additional costs.  If the additional costs put the spell’s  
total cost above 3,000 gp, that spell is not generally available.  
Use a spell level of 1/2 for 0-level spells to calculate the cost.* | n/a | PZO1110 |

<sup>1</sup> Rafts, barges, keelboats, and rowboats are most often used on lakes and rivers. If going downstream, add the speed of the current (typically 3 miles / hour) to the speed of the vehicle. In addition to 10 hours of being rowed, the vehicle can also float an additional 14 hours, if someone can guide it, adding an additional 42 miles to the daily distance traveled. These vehicles can’t be rowed against any significant current, but they can be pulled upstream by draft animals on the shores.
