...
**Success** You [[content/0. DM Screen/Rules/Actions/Leap]] up to a distance equal to your check result rounded down to the nearest 5 feet. You can't jump farther than your land Speed.  
**Failure** You make a normal horizontal Leap.  
**Critical Failure** You make a normal horizontal Leap, then fall and land [[content/0. DM Screen/Rules/Conditions/Prone]].