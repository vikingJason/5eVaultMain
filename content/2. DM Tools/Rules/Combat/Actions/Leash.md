...
A [[whipsaw]] isn't a true whip and can't be used to perform this weapon option. You can use the [[pull]] weapon option on a creature you have leashed, and you have advantage on the attack roll, provided you use the whip that is leashing the target to perform the pull weapon option.
