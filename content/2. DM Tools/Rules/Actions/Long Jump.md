...
**Success** You [[content/2. DM Tools/Rules/Actions/Leap]] up to a distance equal to your check result rounded down to the nearest 5 feet. You can't jump farther than your land Speed.  
**Failure** You make a normal horizontal Leap.  
**Critical Failure** You make a normal horizontal Leap, then fall and land [[content/2. DM Tools/Rules/Conditions/Prone]].