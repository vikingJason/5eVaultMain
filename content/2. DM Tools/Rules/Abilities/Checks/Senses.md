...
Truesight enables a creature to see in normal and magical Darkness, see [[content/0. DM Screen/Rules/Conditions/Invisible]] Creatures and Objects, automatically detect visual illusions and succeed on Saving Throws against them, and perceives the original form of a Shapechanger or a creature that is transformed by magic out to a specific range. Furthermore, the creature can see into the Ethereal Plane.
