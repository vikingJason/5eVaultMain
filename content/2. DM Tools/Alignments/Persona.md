...
**Associated Skill(s)**: Perform (Charm), Linguistics (Genius), or Sense Motive (Sagacity).
...
**Associated Skill(s)**: Fortitude save (DC = 15 + desired Rank), or Diplomacy or Perform check.
...
Source: *Pathfinder Adventure Path #129: The Twilight Child*

These operations do not have a specified tier (Basic versus Advanced) and therefore their availability is at GM discretion. These are intended for use in a situation where the PCs’ networks are in conflict with rival organizations.

**Canny Investment (Genius or Sagacity, Persistent):** Gain a +5 Insight bonus to Profession checks to earn income. You also automatically earn 2d6 gp per week the operation continues.

**Competing Cult (Charm or Sacrifice):** Pass a DC 20 Operation check to draw a cult sentry and high cultist to investigate a location you decide. This can only be performed a limited number of times (twice in a ten-week period in the source).

**Infiltrate Cult (Risky):** DC 15 Operation check. If successful, agents report back with details of a cult ceremony.

**Scout (Heroism or Subterfuge, Risky):** Send your agents to case a location for obvious defenders or hazards. DC is 8 + highest Perception bonus of any defenders.

**Watch Rival Agent (Persistent, Risky):** Have your agents follow an opposing agent. You are not taken by surprise if they dispatch agents against you.
